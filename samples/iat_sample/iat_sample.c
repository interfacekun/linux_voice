...
int main(int argc, char* argv[])
{
	...
	*/
	...
	/*run_iat("/root/linux_voice/bin/wav/iflytek02.wav", session_begin_params); //iflytek02音频内容为“中美数控”；如果上传了用户词表，识别结果为：“中美速控”。
exit:*/
	run_iat("/root/pyaudio/audio/output.wav", session_begin_params); //iflytek02音频内容为“中美数控”；如果上传了用户词表，识别结果为：“中美速控”。
exit:
	//printf("按任意键退出 ...\n");
	//getchar();
	MSPLogout(); //退出登录
